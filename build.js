...
function buildLlmsTxt() {
  ...
  return [
    '# AURA',
    '',
    '> AI marketing automation for advanced aesthetics, medtech and pharmacy.',
    '',
    'AURA is an artificial-intelligence ecosystem that helps advanced aesthetic',
    'clinics, laser and medtech centers, permanent make-up studios, pharmacies',
    'and medical practices find new clients, manage leads and increase sales.',
    '',
    '## What it does',
    '',
    ...
    '  across Facebook and Instagram, for treatments such as laser hair',
    '  removal, cryolipolysis, body contouring, radiofrequency and',
    '  permanent make-up.',
    ...
    '## Who it is for',
    '',
    'Advanced aesthetic clinics, laser hair removal centers, medtech centers,',
    'permanent make-up studios, pharmacies and medical practices that want',
    'more booked appointments without hiring an in-house marketing team.',
    '',
    '## Markets',
    '',
